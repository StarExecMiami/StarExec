...
<%
	...
	if (user == null) {
		// This should not happen if the security constraints are working correctly.
		// Let the security system handle authentication instead of manual redirect.
	...
	System.out.println("unauthorized = " + isUnauthorized);
	...
	if (!isUnauthorized && !isSuspended) {
		...
		return; // Added return after redirect
	}
