<%@page contentType="text/html" pageEncoding="UTF-8"
        import="org.starexec.constants.Web, org.starexec.data.security.GeneralSecurity, org.starexec.util.Mail, org.starexec.util.SessionUtil" %>
...
<%
	...
	try {
		...
		request.setAttribute("hasAdminReadPrivileges",
...
<star:template title="Communities"
               js="shared/sharedFunctions, common/delaySpinner, lib/jquery.dataTables.min, lib/jquery.jstree, explore/communities"
               css="common/delaySpinner, common/table, explore/common, explore/communities">
	<span id="leaderResponse" value="${leaderResponseParameterName}"
	      hidden></span>
	<span id="hasAdminReadPrivileges" value="${hasAdminReadPrivileges}"
	      hidden></span>
	...
	<div id="detailPanel">
		...
		<fieldset>
			...
			<ul id="actionList">
				...
				<li><a id="downloadPreProcessors">download preprocessors</a>
				</li>
				<li><a id="downloadPostProcessors">download postprocessors</a>
				</li>
				<li><a id="downloadBenchProcessors">download benchmark
					processors</a></li>
				<li><a id="downloadUpdateProcessors">download update
					processors</a></li>
	...
	<div id="dialog-confirm-leave" title="leave community" class="hiddenDialog">
		<p><span class="ui-icon ui-icon-alert" aria-hidden="true"></span><span
				id="dialog-confirm-leave-txt"></span></p>
	</div>
