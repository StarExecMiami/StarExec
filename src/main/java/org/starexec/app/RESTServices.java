...
public class RESTServices {
	...
	public String runAllTests(@Context HttpServletRequest request) {
		...
		return success ? gson.toJson(new ValidatorStatusCode(true, "Testing started successfully"))
				: gson.toJson(ERROR_DATABASE);
	...
	public String getTestsPaginated(@Context HttpServletRequest request) {
		...
		JsonObject nextDataTablesPage = RESTHelpers.convertTestSequencesToJsonObject(tests,
	...
	public String getTestResultsPaginated(@PathParam("name") String name, @Context HttpServletRequest request) {
		...
		JsonObject nextDataTablesPage = RESTHelpers.convertTestResultsToJsonObject(tests,
				new DataTablesQuery(tests.size(), tests.size(), -1));
		return nextDataTablesPage == null ? gson.toJson(ERROR_DATABASE) : gson.toJson(nextDataTablesPage);
	}
