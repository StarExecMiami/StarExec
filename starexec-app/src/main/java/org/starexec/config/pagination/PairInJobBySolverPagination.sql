-- gets job pairs for the next page of a datatables table filtered by job ID and solver ID
-- vars
-- stageNumber The stage number to get data for
-- query The query to filter pairs by
-- jobId The ID of the job
-- solverId The ID of the solver to filter by
				...
				WHERE	job_pairs.job_id = :jobId AND
				jobpair_stage_data.solver_id = :solverId AND
