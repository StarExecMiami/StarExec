		...
		<fieldset>
			...
			<table id="tblSolver" class="shaded">
				...
				<tr>
					<td>upload method</td>
					<td>
						local file<input type="radio" id="radioLocal"
						                 name="upMethod" value="local"/>
						URL <input type=radio id="radioURL" name="upMethod"
						           value="URL"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						Archive<input type="radio" id="radioUpload"
						              name="descMethod" value="upload"/>
						Text<input type="radio" id="radioText" name="descMethod"
						           value="text"/>
						Local File<input type="radio" id="radioFile"
						                 name="descMethod" value="file"/>
					</td>
				</tr>
				...
				<tr id="textBoxRow">
					...
					<td>
						<textarea id="description" rows="6" cols="40"
						          name="desc"
						          length="${solverDescLen}"></textarea>
						<input name="d" type="file" id="fileLoc2"/>
						<p id="default">Will search the archive upload for
							starexec_description.txt and extract the
							description</p>
					</td>
				</tr>
				...
				<tr>
					<td>downloadable</td>
					<td>
						<input name="dlable" type="radio" value="true"
				...
				<tr>
					<td title="After uploading this solver, a job will immediately be created in which this solver
						is run against the default benchmark for this community, using community default settings.">
						run test job
					</td>
					<td>
						<input id="useTestJob" class="testJobRadio"
						       name="runTestJob" type="radio"
						       value="true"/><label>yes</label>
						<input id="noTestJob" class="testJobRadio"
						       name="runTestJob" name="runTestJob" type="radio"
						       value="false"
						       checked="checked"/><label>no</label>
					</td>
				</tr>
				<tr id="settingRow" class="noHover"
