...
public final class Web {
    ...
    public static final String SENT_FROM_COMMUNITY_PAGE =
        "sentFromCommunityPage";
    public static final String LOCAL_JOB_PAGE_PARAMETER = "localJobPage";

    public static final String[] JOB_DETAILS_JS_FILES = {
        "util/sortButtons",
        "util/jobDetailsUtilityFunctions",
        "common/delaySpinner",
        "lib/jquery.jstree",
        ...
        "lib/jquery.qtip.min",
        "lib/jquery.heatcolor.0.0.1.min",
        "util/datatablesUtility",
    };
    ...
    public static final String[] CSS_FILES_FOR_LOCAL_JOB = {
        "jqueryui/jquery-ui",
        "global",
        "details/job",
        "details/shared",
    ...
    public static final String[] GLOBAL_PNG_FILES = {
        "loadingGraph",
        "starlogo",
        "external",
    };
