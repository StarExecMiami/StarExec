...
function subscribeUserToReports(userId) {
  postAndReloadPageIfSuccessful(
    starexecRoot + "services/subscribe/user/" + userId,
  );
}

function unsubscribeUserFromReports(userId) {
  postAndReloadPageIfSuccessful(
    starexecRoot + "services/unsubscribe/user/" + userId,
  );
}
...
function grantDeveloperStatus(userId) {
  ...
  postAndReloadPageIfSuccessful(
    starexecRoot + "services/grantDeveloperStatus/user/" + userId,
  );
}
...
function suspendDeveloperStatus(userId) {
  ...
  postAndReloadPageIfSuccessful(
    starexecRoot + "services/suspendDeveloperStatus/user/" + userId,
  );
}
