<%@page contentType="text/html" pageEncoding="UTF-8"
        import="org.starexec.data.database.Settings, org.starexec.data.security.SettingSecurity, org.starexec.data.to.DefaultSettings, org.starexec.data.to.DefaultSettings.SettingType, org.starexec.util.SessionUtil"
        session="true" %>
...
<%
	...
	try {
		...
		if ((type.equals("solver") || type.equals("benchmark")) &&
				SettingSecurity.canModifySettings(id, userId).isSuccess()) {
...
<star:template title="select default ${type}"
	...
	<fieldset>
		<form id="selectDefaultPrim">
			<fieldset>
				<legend class="expd" id="primExpd"><span>0</span> ${type}s
				</legend>
				<table id="prims">
					<thead>
					<tr>
