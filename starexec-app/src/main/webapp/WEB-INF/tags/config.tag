...
<a title="${value.description}" href="${starexecRoot}/secure/details/configuration.jsp?id=${value.id}" target="_blank" rel="noopener noreferrer">${value.name}<img class="extLink" src="${starexecRoot}/images/external.png" alt=""/></a>
