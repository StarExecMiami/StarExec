...
<a href="${starexecRoot}/secure/details/user.jsp?id=${value.id}" target="_blank" rel="noopener noreferrer">${value.fullName}<img class="extLink" src="${starexecRoot}/images/external.png" alt=""/></a>
