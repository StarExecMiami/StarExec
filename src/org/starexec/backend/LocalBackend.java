...
/**
 * This backend implementation does not rely on any external system outside of
 * basic Unix
 * utilities. It uses a single static queue and node and runs a single job pair
 * at a time
 *
 */
public class LocalBackend implements Backend {
    ...
    /**
     * Loops forever, executing the jobs in jobsToRun. Sleeps for 20 seconds at a
     * time if the queue is empty, and
