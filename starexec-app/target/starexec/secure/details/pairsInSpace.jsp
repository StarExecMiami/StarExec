	...
	try {
		...
		if (space == null ||
			...
			response.sendError(
					...
					"This job has been deleted or is restricted"
			);
			return;
		}
...
<star:template
	...
	<fieldset id="#pairTblField">
		...
		<fieldset id="pairActions" class="tableActions">
			...
			<button asc="true" class="sortButton" id="idSort" value="6">sort by
				id
			</button>
			<button asc="true" class="sortButton" id="collapsePanels" value="7">
