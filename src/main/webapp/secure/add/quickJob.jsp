	...
	<form id="addForm" method="post" action="${starexecRoot}/secure/add/job">
		...
		<fieldset id="baseSettings">
			...
			<table id="tblConfig" class="shaded contentTbl">
				...
				<tr class="noHover"
				    title="what solver would you like to run during this job?">
					<td class="label"><p>solver</p></td>
					<td><input id="solver" type="hidden" name="solver"/>
						<p id="solverNameField"></p></td>
				</tr>
				<tr class="noHover"
				    title="Enter the contents of the benchmark.">
					<td>benchmark contents</td>
					<td><textarea id="benchmarkField" name="bench"></textarea>
					</td>
				</tr>
				</tbody>
			</table>
		...
		<fieldset id="advancedSettings">
			...
			<table id="tblAdvancedConfig" class="shaded contentTbl">
				...
				<tr class="noHover"
				    title="do you want to extract any attributes from your benchmark?">
					<td class="label"><p>bench processor</p></td>
					<td>
						<select class="benchProcessSetting" id="benchProcess"
						        name="benchProcess">
