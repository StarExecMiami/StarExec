...
<star:template title="upload XML configuration for a job in ${space.name}"
	...
	<form method="POST" enctype="multipart/form-data"
		...
		<fieldset>
			<legend id="upload-legend">upload job XML configuration</legend>
			...
			<div class="help-links">
				<a id="viewSchema" href="../../public/batchJobSchema.xsd" class="help-link">
					<span class="ui-icon ui-icon-document" aria-hidden="true"></span>
					View XML Schema
				</a>
				<a id="viewExample" href="../../public/ExampleJob.xml" class="help-link">
					<span class="ui-icon ui-icon-document" aria-hidden="true"></span>
					View Example File
				</a>
			</div>
